...
function networkDown() {
  ...
  rm ../blockchain-api/fabric-client-kv-org* -rf
...
function generatePrivateKey(){
    # copy peer private key
  cp crypto-config/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp/keystore/* crypto-config/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp/keystore/priv_sk 
  cp crypto-config/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp/keystore/* crypto-config/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp/keystore/priv_sk 
